...
<section id="certifications" className="mt-16 flex justify-center">
  <div className="container mx-auto px-6 text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center">
      ...
      <div className="skill-card">
        <div className="flex justify-center">
          <img src="https://drm.file.force.com/servlet/servlet.ImageServer?id=0153k00000BEqgH&oid=00DF0000000gZsu&lastMod=1693557495000" width={200} height={200} alt="Salesforce AI Associate" />
        </div>
